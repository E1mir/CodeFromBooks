from HeadFirstDesignPatterns.chapter_9.composite.models import MenuComponent, MenuItem, Menu
from HeadFirstDesignPatterns.chapter_9.composite.waitress import Waitress
